...
\begin{tikzpicture}[
    ...
    danger_arrow/.style={-{Stealth[scale=1.1]}, thick, draw=danger, dashed}
]
    ...
    \draw[danger_arrow] (orchestrator) -- node[above, font=\scriptsize, text=danger] {Unprotected Call} (mock);
    \draw[danger_arrow] (refunds) -- node[right, font=\scriptsize, text=danger] {Unprotected Call} (mock);
    \draw[danger_arrow] (mock) -- (sqlite);
