...
\begin{tikzpicture}[
    node distance=1cm,
    stepbox/.style={rectangle, draw=primary, thick, fill=bglight, minimum width=4cm, minimum height=0.8cm, rounded corners=4pt, font=\small, drop shadow=black!5, align=center},
