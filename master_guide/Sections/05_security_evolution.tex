...
\begin{tikzpicture}[
    node distance=1.5cm,
    actor/.style={circle, draw=textdark, thick, fill=bglight, minimum size=1.2cm, font=\small\bfseries},
...
\begin{tikzpicture}[
    node distance=1.5cm,
    gateway/.style={rectangle, draw=accent, thick, fill=bglight, minimum width=3cm, minimum height=1cm, rounded corners=4pt, font=\small\bfseries},
    payload/.style={rectangle, draw=textdark, dashed, minimum width=2.5cm, minimum height=0.8cm, font=\scriptsize},
