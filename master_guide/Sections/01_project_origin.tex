...
\begin{tikzpicture}[
    node distance=0.8cm,
    stepbox/.style={rectangle, draw=primary!60, thick, fill=bglight, minimum width=4.5cm, minimum height=1cm, rounded corners=4pt, font=\small, text=textdark, drop shadow=black!5, align=center},
...
\begin{tikzpicture}[
    node distance=0.5cm,
    weak/.style={rectangle, draw=danger!50, thick, fill=danger!5, minimum width=7cm, minimum height=0.8cm, rounded corners=3pt, font=\small, text=textdark, align=center},
]
