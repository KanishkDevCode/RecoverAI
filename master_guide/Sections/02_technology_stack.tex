...
\begin{tikzpicture}[
    ...
    tech/.style={rectangle, draw=primary!50, thick, fill=white, minimum width=2.8cm, minimum height=1cm, rounded corners=4pt, font=\small\bfseries, text=textdark, drop shadow=black!5, align=center},
    infra/.style={rectangle, draw=secondary!50, thick, fill=secondary!5, minimum width=2.8cm, minimum height=1cm, rounded corners=4pt, font=\small\bfseries, text=textdark, drop shadow=black!5, align=center},
