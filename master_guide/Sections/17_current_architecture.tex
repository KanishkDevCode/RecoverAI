...
\begin{tikzpicture}[
    ...
    client/.style={circle, draw=textdark, thick, fill=bglight, minimum size=1.2cm, font=\small\bfseries},
    ...
    worker/.style={rectangle, draw=primary, thick, fill=bglight, minimum width=3.5cm, minimum height=1cm, rounded corners=4pt, font=\small\bfseries, text=textdark, drop shadow=black!5},
    redis/.style={cylinder, draw=danger, thick, fill=danger!10, shape border rotate=90, aspect=0.25, minimum width=2.5cm, minimum height=1.2cm, font=\small\bfseries, text=danger, drop shadow=black!5},
    pg/.style={cylinder, draw=accent, thick, fill=accent!10, shape border rotate=90, aspect=0.25, minimum width=3.5cm, minimum height=2cm, font=\small\bfseries, text=accent, drop shadow=black!5},
    guard/.style={rectangle, draw=success, thick, fill=success!15, minimum width=3.5cm, minimum height=1cm, rounded corners=4pt, font=\small\bfseries, text=success!70!black, drop shadow=black!5},
    gw/.style={rectangle, draw=textdark, dashed, fill=textdark!10, minimum width=3cm, minimum height=1cm, rounded corners=4pt, font=\small\bfseries},
