...
\begin{tikzpicture}[
    node distance=0.5cm,
    step/.style={rectangle, draw=secondary, thick, fill=white, minimum width=12cm, minimum height=0.8cm, rounded corners=2pt, font=\small, text=textdark, align=left},
]
    \node[step] (b5) {\textbf{Batch 5.0:} Target state definition (PostgreSQL, Celery, Redis)};
