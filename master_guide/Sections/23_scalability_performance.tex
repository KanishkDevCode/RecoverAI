...
\begin{tikzpicture}[
    node distance=1.5cm,
    api/.style={rectangle, draw=secondary, thick, fill=bglight, minimum width=2.5cm, minimum height=1cm, rounded corners=4pt, font=\small\bfseries, drop shadow=black!5},
    redis/.style={cylinder, draw=danger, thick, fill=danger!10, shape border rotate=90, aspect=0.25, minimum width=2cm, minimum height=1.2cm, font=\small\bfseries, text=danger, drop shadow=black!5},
    worker/.style={rectangle, draw=primary, thick, fill=primary!10, minimum width=2.5cm, minimum height=0.8cm, rounded corners=4pt, font=\scriptsize\bfseries},
