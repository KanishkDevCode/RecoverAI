...
\begin{tikzpicture}[
    ...
    impl/.style={rectangle, draw=secondary, thick, fill=bglight, minimum width=3cm, minimum height=0.8cm, rounded corners=4pt, font=\scriptsize\ttfamily, drop shadow=black!5},
