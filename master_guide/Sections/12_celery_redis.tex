...
\begin{tikzpicture}[
    ...
    redis/.style={cylinder, draw=danger, thick, fill=danger!10, shape border rotate=90, aspect=0.25, minimum width=3cm, minimum height=1.5cm, font=\small\bfseries, text=danger, drop shadow=black!5},
