...
\begin{tikzpicture}[
    ...
    step/.style={rectangle, draw=secondary, thick, fill=bglight, minimum width=2.5cm, minimum height=0.8cm, rounded corners=4pt, font=\small\bfseries, drop shadow=black!5, align=center},
    ...
    \node[step, right=of db] (feat) {Feature\\Extractor};
    \node[step, right=of feat] (scaler) {Standard\\Scaler};
