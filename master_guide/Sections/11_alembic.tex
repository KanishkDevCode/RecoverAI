...
\begin{tikzpicture}[
    node distance=1.5cm,
    script/.style={rectangle, draw=secondary, thick, fill=bglight, minimum width=3cm, minimum height=1cm, rounded corners=4pt, font=\small\bfseries, drop shadow=black!5},
    db/.style={cylinder, draw=primary, thick, fill=primary!10, shape border rotate=90, aspect=0.25, minimum width=2.5cm, minimum height=1.5cm, font=\small\bfseries, drop shadow=black!5},
    table/.style={rectangle, draw=textdark, dashed, fill=white, minimum width=2.5cm, minimum height=0.6cm, font=\scriptsize\ttfamily},
